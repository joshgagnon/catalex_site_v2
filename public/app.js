...
/***/ function(module, exports, __webpack_require__) {
	...
	if ((0, _jquery2.default)('.scroll-row').length) {
	    (0, _jquery2.default)('.scroll-row .fade-container').addClass('animate');
	    (0, _jquery2.default)('.scroll-row .fade-container').bind('inview', function (event, isInView, visiblePartX, visiblePartY) {

	        if (isInView) {
	            (0, _jquery2.default)(this).addClass('fade-in').unbind('inview');
	        }
	    });
	}
